...
SELECT unnest(ARRAY[
    'Git', 'Django', 'Figma', 'Software Testing', 'CI/CD', 'Java', 'Spring Framework', 'CSS', 'UnrealEngine', 
    'pandas', 'Docker', 'Flask', 'MongoDB', 'Numpy', 'Python', 'Strategic Planning', 'ML', 'Kubernetes', 
    'Spring Boot', 'SQL', 'JavaScript', 'Accounting', 'FastAPI', 'React', 'Public Speaking', 'PyTorch', 'Hyper-V', 
    'Teamwork', 'HTML', 'Kafka', 'TypeScript', 'Strategy', 'Research', 'Management', 'Angular', 'HTML5', 'Ansible', 
    'Agile', 'Leadership Development', 'PostgreSQL', 'Azure', 'Terraform', 'Selenium', 'Jenkins', 'Sketch', 
    'AdobeXD', 'Математическая статистика', 'NLP', 'Django Framework', 'Scrum', 'REST', 'Leadership', 'TensorFlow', 
