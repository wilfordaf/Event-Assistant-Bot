welcome_message_text = (
    'Бот "НаСвязи" поможет вам определить наиболее интересные контакты на мероприятии. '
...
def list_candidates_from_event_message_text(event_name: str) -> str:
    return f"Список наиболее подходящих кандидатов из события " f'"{event_name}": \n\n'


def list_participants_of_event_message_text(event_name: str) -> str:
    return f"Список участников события " f'"{event_name}": \n\n'


def event_was_created_message_text(event_name: str) -> str:
    return f'Мероприятие "{event_name}" успешно создано!'


def on_event_page_message_text(event_name: str) -> str:
    return f"Вы находитесь в мероприятии {event_name}"


def event_page_with_empty_profile_message_text(event_name: str) -> str:
    return (
        f'Вы находитесь в мероприятии "{event_name}". '
